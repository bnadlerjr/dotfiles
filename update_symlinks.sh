...
DOTFILES=( asdfrc bash_profile bashrc ctags default-gems default-npm-packages editorconfig emacs.d fzf-git.sh gemrc gitconfig gitignore_global gvimrc iex.exs lein npmrc psqlrc tmux.conf tool-versions vimrc vim )

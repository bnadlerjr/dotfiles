...
DOTFILES=( bash_profile bashrc ctags default-gems default-npm-packages emacs.d gemrc gitconfig gitignore_global gvimrc iex.exs lein psqlrc tmux.conf tool-versions vimrc vim )

...
DOTFILES=( asdfrc bash_profile bashrc ctags default-gems default-npm-packages editorconfig emacs.d gemrc gitconfig gitignore_global gvimrc iex.exs lein npmrc psqlrc tmux.conf tool-versions vimrc vim )
